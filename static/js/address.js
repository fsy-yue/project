...
var province='请选择省份', city = '请选择城市', area='请选择区县';
var province_val = $('.province').text();
var city_val = $('.city').text();
var area_val = $('.area').text();
if (province_val) {
...
// 	]
// },
{name:province,cityList:[
{name:city,areaList:[area]}
]},
{name:'北京市', cityList:[
